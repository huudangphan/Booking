...
{
    public class DomesticTravelVariableModel
    {
        [JsonProperty("ResponseDomestic")]
        public ResponseDomestic[] ResponseDomestic { get; set; }
    }
    public partial class ResponseDomestic
    {
        [JsonProperty("type")]
        ...
        public RegionDomestic[] Regions { get; set; }
    }

    public partial class CategoryDomestic
    {
        ...
        public ExposurePeriodDomestic ExposurePeriod { get; set; }
    ...
    public partial class ExposurePeriodDomestic
    {
    ...
    public partial class RegionDomestic
    {
        [JsonProperty("id")]
