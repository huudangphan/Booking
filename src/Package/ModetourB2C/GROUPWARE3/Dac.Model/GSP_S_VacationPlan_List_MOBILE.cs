...
/// <summary>
/// GSP_S_휴가계_리스트_MOBILE
/// </summary>
public class GSP_S_VacationPlan_List_MOBILE
{
	public const string SP_NAME = "GSP_S_휴가계_리스트_MOBILE";
	...
	public class Result4 : IDbResult
	{
		...
		/// </summary>
		[Column("모바일상신여부")]
		public string MobileReportOrNot { get; set; }
	}
}