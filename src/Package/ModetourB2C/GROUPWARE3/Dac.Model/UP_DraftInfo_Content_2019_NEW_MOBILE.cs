...
/// <summary>
/// UP_기안정보_내용_2019_NEW_MOBILE
/// </summary>
public class UP_DraftInfo_Content_2019_NEW_MOBILE
{
	public const string SP_NAME = "UP_기안정보_내용_2019_NEW_MOBILE";
	...
	public class Result2 : IDbResult
	{
		...
		/// </summary>
		[Column("사전비용승인설정여부")]
		public string PreExpenseApprovalSettingOrNot { get; set; }
		/// <summary>
		/// 양식번호
		/// </summary>
		[Column("양식번호")]
