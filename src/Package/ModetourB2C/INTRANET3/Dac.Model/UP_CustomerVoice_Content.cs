...
/// UP_고객의소리_내용
/// </summary>
public class UP_CustomerVoice_Content
{
	public const string SP_NAME = "UP_고객의소리_내용";
	...
	public class Result1 : IDbResult
	{
		...
		/// </summary>
		[Column("상품담당부서")]
		public int ProductResponsibilityDepartment { get; set; }
		/// <summary>
		/// 영업담당자
		/// </summary>
		[Column("영업담당자")]
		...
		/// </summary>
		[Column("영업담당부서")]
		public int BusinessResponsibilityDepartment { get; set; }
		/// <summary>
		/// 상품진행현황
		/// </summary>
		[Column("상품진행현황")]
		...
		/// </summary>
		[Column("단체행사세부번호")]
		public int GroupEventDetailNumber { get; set; }
		/// <summary>
		/// 항목
		/// </summary>
		[Column("항목")]
	...
	public class Result2 : IDbResult
	{
		...
		/// </summary>
		[Column("진행글수")]
		public int ProgressCharactersNumber { get; set; }
		/// <summary>
		/// 고객메일발송수
		/// </summary>
		[Column("고객메일발송수")]
		public int CustomerMailSendingNumber { get; set; }
	}
