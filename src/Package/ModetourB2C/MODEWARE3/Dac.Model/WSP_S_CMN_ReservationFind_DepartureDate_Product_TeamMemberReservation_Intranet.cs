...
/// <summary>
/// WSP_S_CMN_예약조회_출발일_상품_팀원예약_인트라넷
/// </summary>
public class WSP_S_CMN_ReservationFind_DepartureDate_Product_TeamMemberReservation_Intranet
{
	public const string SP_NAME = "WSP_S_CMN_예약조회_출발일_상품_팀원예약_인트라넷";
