...
/// WSP_S_CMN_복지몰_단체일정
/// </summary>
public class WSP_S_CMN_WelfareMall_GroupSchedule
{
	public const string SP_NAME = "WSP_S_CMN_복지몰_단체일정";
	...
	public class Result2 : IDbResult
	{
		...
		/// </summary>
		[Column("대기TL적용일")]
		public DateTime Waiting_TL_ApplyingDate { get; set; }
		/// <summary>
		/// 즉시예약
		/// </summary>
		[Column("즉시예약")]
		...
		/// </summary>
		[Column("성인_판매가격")]
		public int Adult_SalesPrice { get; set; }
		/// <summary>
		/// 성인_추가금액
		/// </summary>
		[Column("성인_추가금액")]
		public int Adult_AdditionalAmount { get; set; }
		/// <summary>
		/// 성인_할인가격_OK
		/// </summary>
		[Column("성인_할인가격_OK")]
		public int Adult_DiscountPrice_OK { get; set; }
		/// <summary>
		/// 성인_할인가격_WT
		/// </summary>
		[Column("성인_할인가격_WT")]
		public int Adult_DiscountPrice_WT { get; set; }
		/// <summary>
		/// 성인_최종가격_OK
		/// </summary>
		[Column("성인_최종가격_OK")]
		public int Adult_FinalPrice_OK { get; set; }
		/// <summary>
		/// 성인_최종가격_OK_추가금액제외
		/// </summary>
		[Column("성인_최종가격_OK_추가금액제외")]
		public int Adult_FinalPrice_OK_AdditionalAmountException { get; set; }
		/// <summary>
		/// 성인_최종가격_WT
		/// </summary>
		[Column("성인_최종가격_WT")]
		public int Adult_FinalPrice_WT { get; set; }
		/// <summary>
		/// 성인_최종가격_WT_추가금액제외
		/// </summary>
		[Column("성인_최종가격_WT_추가금액제외")]
		public int Adult_FinalPrice_WT_AdditionalAmountException { get; set; }
		/// <summary>
		/// 소아N_판매가격
		/// </summary>
		[Column("소아N_판매가격")]
		public int Kid_N_SalesPrice { get; set; }
		/// <summary>
		/// 소아N_추가금액
		/// </summary>
		[Column("소아N_추가금액")]
		public int Kid_N_AdditionalAmount { get; set; }
		/// <summary>
		/// 소아N_할인금액_OK
		/// </summary>
		[Column("소아N_할인금액_OK")]
		...
		/// </summary>
		[Column("소아N_최종가격_OK")]
		public int Kid_N_FinalPrice_OK { get; set; }
		/// <summary>
		/// 소아N_최종가격_OK_추가금액제외
		/// </summary>
		[Column("소아N_최종가격_OK_추가금액제외")]
		public int Kid_N_FinalPrice_OK_AdditionalAmountException { get; set; }
		/// <summary>
		/// 소아N_최종가격_WT
		/// </summary>
		[Column("소아N_최종가격_WT")]
		public int Kid_N_FinalPrice_WT { get; set; }
		/// <summary>
		/// 소아N_최종가격_WT_추가금액제외
		/// </summary>
		[Column("소아N_최종가격_WT_추가금액제외")]
		public int Kid_N_FinalPrice_WT_AdditionalAmountException { get; set; }
		/// <summary>
		/// 소아E_판매가격
		/// </summary>
		[Column("소아E_판매가격")]
		public int Kid_E_SalesPrice { get; set; }
		/// <summary>
		/// 소아E_추가금액
		/// </summary>
		[Column("소아E_추가금액")]
		public int Kid_E_AdditionalAmount { get; set; }
		/// <summary>
		/// 소아E_할인금액_OK
		/// </summary>
		[Column("소아E_할인금액_OK")]
		...
		/// </summary>
		[Column("소아E_최종가격_OK")]
		public int Kid_E_FinalPrice_OK { get; set; }
		/// <summary>
		/// 소아E_최종가격_OK_추가금액제외
		/// </summary>
		[Column("소아E_최종가격_OK_추가금액제외")]
		public int Kid_E_FinalPrice_OK_AdditionalAmountException { get; set; }
		/// <summary>
		/// 소아E_최종가격_WT
		/// </summary>
		[Column("소아E_최종가격_WT")]
		public int Kid_E_FinalPrice_WT { get; set; }
		/// <summary>
		/// 소아E_최종가격_WT_추가금액제외
		/// </summary>
		[Column("소아E_최종가격_WT_추가금액제외")]
		public int Kid_E_FinalPrice_WT_AdditionalAmountException { get; set; }
		/// <summary>
		/// 유아_판매가격
		/// </summary>
		[Column("유아_판매가격")]
		public int Toddler_SalesPrice { get; set; }
		/// <summary>
		/// 유아_추가금액
		/// </summary>
		[Column("유아_추가금액")]
		public int Toddler_AdditionalAmount { get; set; }
		/// <summary>
		/// 유아_할인금액_OK
		/// </summary>
		[Column("유아_할인금액_OK")]
		...
		/// </summary>
		[Column("유아_최종가격_OK")]
		public int Toddler_FinalPrice_OK { get; set; }
		/// <summary>
		/// 유아_최종가격_OK_추가금액제외
		/// </summary>
		[Column("유아_최종가격_OK_추가금액제외")]
		public int Toddler_FinalPrice_OK_AdditionalAmountException { get; set; }
		/// <summary>
		/// 유아_최종가격_WT
		/// </summary>
		[Column("유아_최종가격_WT")]
		public int Toddler_FinalPrice_WT { get; set; }
		/// <summary>
		/// 유아_최종가격_WT_추가금액제외
		/// </summary>
		[Column("유아_최종가격_WT_추가금액제외")]
		public int Toddler_FinalPrice_WT_AdditionalAmountException { get; set; }
		/// <summary>
		/// 단체번호
		/// </summary>
		[Column("단체번호")]
