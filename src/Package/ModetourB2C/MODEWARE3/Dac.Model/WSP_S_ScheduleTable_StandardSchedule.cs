...
/// WSP_S_일정표_표준일정
/// </summary>
public class WSP_S_ScheduleTable_StandardSchedule
{
	public const string SP_NAME = "WSP_S_일정표_표준일정";
	...
	public class Parameters : BaseDbParameters
	{
		...
		/// </summary>
		[Description("표준일정번호")]
		public int StandardScheduleNumber { get; set; }
	}
	...
	public class Result4 : IDbResult
	{
		...
		/// </summary>
		[Column("표준일정세부번호")]
		public int StandardScheduleDetailNumber { get; set; }
		/// <summary>
		/// 표준일정번호
		/// </summary>
		[Column("표준일정번호")]
