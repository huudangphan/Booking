...
/// USP_S_인센티브마스터상세_NEW
/// </summary>
public class USP_S_IncentiveMasterDetail_NEW
{
	public const string SP_NAME = "USP_S_인센티브마스터상세_NEW";
	...
	public class Result : IDbResult
	{
		...
		/// </summary>
		[Column("단체성격코드")]
		public string GroupCharacterCode { get; set; }
		/// <summary>
		/// 희망일인요금
		/// </summary>
		[Column("희망일인요금")]
		...
		/// </summary>
		[Column("입금가CRS")]
		public int DepositPriceCRS { get; set; }
		/// <summary>
		/// 영업비고CRS
		/// </summary>
		[Column("영업비고CRS")]
		public string BusinessNote_CRS { get; set; }
		/// <summary>
		/// 첨부파일_대리점전달CRS
		/// </summary>
		[Column("첨부파일_대리점전달CRS")]
		public string AttachFile_AgencySending_CRS { get; set; }
		/// <summary>
		/// 영업코디부서
		/// </summary>
		[Column("영업코디부서")]
		public string BusinessCoordinationDepartment { get; set; }
		/// <summary>
		/// 영업코디
		/// </summary>
		[Column("영업코디")]
		public string BusinessCoordination { get; set; }
		/// <summary>
		/// 영업코디부서번호
		/// </summary>
		[Column("영업코디부서번호")]
		public int BusinessCoordinationDepartmentNumber { get; set; }
		/// <summary>
		/// 영업코디번호
		/// </summary>
		[Column("영업코디번호")]
		public int BusinessCoordinationNumber { get; set; }
		/// <summary>
		/// 내선_영업코디
		/// </summary>
		[Column("내선_영업코디")]
		public string Interphone_BusinessCoordination { get; set; }
		/// <summary>
		/// 휴대폰_영업코디
		/// </summary>
		[Column("휴대폰_영업코디")]
		public string Phone_BusinessCoordination { get; set; }
		/// <summary>
		/// SB사용제한권고
		/// </summary>
		[Column("SB사용제한권고")]
