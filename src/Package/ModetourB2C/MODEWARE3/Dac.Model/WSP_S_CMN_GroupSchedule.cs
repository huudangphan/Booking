...
/// WSP_S_CMN_단체일정
/// </summary>
public class WSP_S_CMN_GroupSchedule
{
	public const string SP_NAME = "WSP_S_CMN_단체일정";
	...
	public class Result1 : IDbResult
	{
		...
		/// </summary>
		[Column("특선상품할인율")]
		public int SpecialSelectedProductDiscountRate { get; set; }
		/// <summary>
		/// 방문지리스트
		/// </summary>
		[Column("방문지리스트")]
	...
	public class Result2 : IDbResult
	{
		...
		/// </summary>
		[Column("판매가_어른2")]
		public int SellingPrice_Adult2 { get; set; }
		/// <summary>
		/// 판매가_소아N2
		/// </summary>
		[Column("판매가_소아N2")]
		public int SellingPrice_Kid_N2 { get; set; }
		/// <summary>
		/// 판매가_소아E2
		/// </summary>
		[Column("판매가_소아E2")]
		public int SellingPrice_Kid_E2 { get; set; }
		/// <summary>
		/// 판매가_유아2
		/// </summary>
		[Column("판매가_유아2")]
		public int SellingPrice_Toddler2 { get; set; }
		/// <summary>
		/// 판매가_랜드2
		/// </summary>
		[Column("판매가_랜드2")]
		public int SellingPrice_Land2 { get; set; }
		/// <summary>
		/// 판매가_어른
		/// </summary>
		[Column("판매가_어른")]
		...
		/// </summary>
		[Column("동반자할인")]
		public string AccompaniedPeopleDiscount { get; set; }
		/// <summary>
		/// 선착순할인프로모션
		/// </summary>
		[Column("선착순할인프로모션")]
		public string FirstComeFirstServedOrderDiscountPromotion { get; set; }
		/// <summary>
		/// 현지행사정보
		/// </summary>
		[Column("현지행사정보")]
		...
		/// </summary>
		[Column("단체담당_현지여행사")]
		public string GroupManage_LocalTravelCompany { get; set; }
		/// <summary>
		/// 센딩여부
		/// </summary>
		[Column("센딩여부")]
	...
	public class Result5 : IDbResult
	{
		...
		/// </summary>
		[Column("일정포함여부")]
		public string ScheduleIncludedOrNot { get; set; }
		/// <summary>
		/// 지역1
		/// </summary>
		[Column("지역1")]
		...
		/// </summary>
		[Column("단체일정순서")]
		public int GroupScheduleOrder { get; set; }
		/// <summary>
		/// PLACE순서
		/// </summary>
		[Column("PLACE순서")]
		...
		/// </summary>
		[Column("PLACE설정구분")]
		public string PLACE_SettingClassification { get; set; }
		/// <summary>
		/// PLACE노출아이콘형식
		/// </summary>
		[Column("PLACE노출아이콘형식")]
		public string PLACE_DisplayIconFormat { get; set; }
	}
	...
	public class Result9 : IDbResult
	{
		...
		/// </summary>
		[Column("단체조건번호")]
		public int GroupConditionNumber { get; set; }
		/// <summary>
		/// 단체번호
		/// </summary>
		[Column("단체번호")]
		...
		/// </summary>
		[Column("현지공항세포함여부")]
		public string LocalAirportTaxIncludeOrNot { get; set; }
		/// <summary>
		/// 식사료코드
		/// </summary>
		[Column("식사료코드")]
		public string MealFeeCode { get; set; }
		/// <summary>
		/// 현지교통CSV
		/// </summary>
		[Column("현지교통CSV")]
		public string LocalTransportation_CSV { get; set; }
		/// <summary>
		/// 숙박료코드
		/// </summary>
		[Column("숙박료코드")]
		public string LodgingFeeCode { get; set; }
		/// <summary>
		/// 관광지입장료
		/// </summary>
		[Column("관광지입장료")]
		...
		/// </summary>
		[Column("현지필수경비포함여부")]
		public string LocalRequiredExpenseIncludeOrNot { get; set; }
		/// <summary>
		/// 인솔자동반코드
		/// </summary>
		[Column("인솔자동반코드")]
		public string LeaderAccompanyCode { get; set; }
		/// <summary>
		/// 인솔자동반_최소행사인원
		/// </summary>
		[Column("인솔자동반_최소행사인원")]
		public int LeaderAccompany_MinimumEventStaff { get; set; }
		/// <summary>
		/// 현지가이드포함여부
		/// </summary>
		[Column("현지가이드포함여부")]
		...
		/// </summary>
		[Column("여행자보험포함여부")]
		public string TravelerInsuranceIncludeOrNot { get; set; }
		/// <summary>
		/// 여행자보험사
		/// </summary>
		[Column("여행자보험사")]
		...
		/// </summary>
		[Column("여행자보험보장액")]
		public string TravelerInsuranceGuaranteeAmount { get; set; }
		/// <summary>
		/// 긴급모객여부
		/// </summary>
		[Column("긴급모객여부")]
		...
		/// </summary>
		[Column("여행테마CSV")]
		public string TravelTheme_CSV { get; set; }
		/// <summary>
		/// 최대행사인원
		/// </summary>
		[Column("최대행사인원")]
		public int MaximumEventStaff { get; set; }
		/// <summary>
		/// 전용버스연식코드
		/// </summary>
		[Column("전용버스연식코드")]
		public string ExclusiveBusModelCode { get; set; }
		/// <summary>
		/// 전용버스크기코드
		/// </summary>
		[Column("전용버스크기코드")]
		public string ExclusiveBusSizeCode { get; set; }
		/// <summary>
		/// 쇼핑횟수
		/// </summary>
		[Column("쇼핑횟수")]
		...
		/// </summary>
		[Column("선택관광유무")]
		public string SelectionSightseeingOrNot { get; set; }
		/// <summary>
		/// 자유일정코드
		/// </summary>
		[Column("자유일정코드")]
		public string FreeScheduleCode { get; set; }
		/// <summary>
		/// 자유일정식사코드
		/// </summary>
		[Column("자유일정식사코드")]
		public string FreeScheduleMealCode { get; set; }
		/// <summary>
		/// 취소료적용약관코드
		/// </summary>
		[Column("취소료적용약관코드")]
		public string CancellationFeeApplyingTermsAndConditionsCode { get; set; }
		/// <summary>
		/// 좌석업그레이드비용
		/// </summary>
		[Column("좌석업그레이드비용")]
		public int SeatUpgradeFee { get; set; }
		/// <summary>
		/// 싱글룸사용료
		/// </summary>
		[Column("싱글룸사용료")]
		public int SingleRoomUsingFee { get; set; }
		/// <summary>
		/// 비자포함여부
		/// </summary>
		[Column("비자포함여부")]
		...
		/// </summary>
		[Column("비자발급비용")]
		public int VisaIssuanceFee { get; set; }
		/// <summary>
		/// 최소출발인원
		/// </summary>
		[Column("최소출발인원")]
		...
		/// </summary>
		[Column("비자발급비_통화코드")]
		public string VisaIssuanceFee_CommunicationCode { get; set; }
		/// <summary>
		/// 항공좌석등급코드
		/// </summary>
		[Column("항공좌석등급코드")]
