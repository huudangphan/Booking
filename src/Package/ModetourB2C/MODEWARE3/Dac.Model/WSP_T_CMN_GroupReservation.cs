...
/// WSP_T_CMN_단체예약
/// </summary>
public class WSP_T_CMN_GroupReservation
{
	public const string SP_NAME = "WSP_T_CMN_단체예약";
	...
	public class Parameters : BaseDbParameters
	{
		...
		/// 여행자ETICKET요청이메일
		/// </summary>
		[Description("여행자ETICKET요청이메일")]
		public string Traveler_ETICKET_RequestEmail { get; set; }
		/// <summary>
		/// 판매종류코드
		/// </summary>
		[Description("판매종류코드")]
