...
/// <summary>
/// WSP_S_센딩_무인센딩_고객체크_생년월일로조회
/// </summary>
public class WSP_S_Sending_UnmannedSending_CustomerCheck_FindByBirthday
{
	public const string SP_NAME = "WSP_S_센딩_무인센딩_고객체크_생년월일로조회";
