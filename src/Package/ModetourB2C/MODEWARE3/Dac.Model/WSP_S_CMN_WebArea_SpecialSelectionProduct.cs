...
/// WSP_S_CMN_웹구역_특선상품
/// </summary>
public class WSP_S_CMN_WebArea_SpecialSelectionProduct
{
	public const string SP_NAME = "WSP_S_CMN_웹구역_특선상품";
	...
	public class Result : IDbResult
	{
		...
		/// </summary>
		[Column("웹지역")]
		public int WebRegion { get; set; }
		/// <summary>
		/// 웹테마
		/// </summary>
		[Column("웹테마")]
		public int WebTheme { get; set; }
		/// <summary>
		/// 출발지
		/// </summary>
		[Column("출발지")]
