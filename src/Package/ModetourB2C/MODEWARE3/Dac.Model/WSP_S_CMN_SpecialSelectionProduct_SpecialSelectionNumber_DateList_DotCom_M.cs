...
/// <summary>
/// WSP_S_CMN_특선상품_특선번호_날짜리스트_닷컴M
/// </summary>
public class WSP_S_CMN_SpecialSelectionProduct_SpecialSelectionNumber_DateList_DotCom_M
{
	public const string SP_NAME = "WSP_S_CMN_특선상품_특선번호_날짜리스트_닷컴M";
