...
/// <summary>
/// WSP_S_CMN_테마_출발지별_맞춤검색_지역기준
/// </summary>
public class WSP_S_CMN_Theme_EachDepartures_MatchingSearch_RegionStandard
{
	public const string SP_NAME = "WSP_S_CMN_테마_출발지별_맞춤검색_지역기준";
	...
	public class Parameters : BaseDbParameters
	{
		...
		/// </summary>
		[Description("희망가1")]
		public int DesiredPrice1 { get; set; }
		/// <summary>
		/// 희망가2
		/// </summary>
		[Description("희망가2")]
		public int DesiredPrice2 { get; set; }
		/// <summary>
		/// 여행기간1
		/// </summary>
		[Description("여행기간1")]
		public int TravelPeriod1 { get; set; }
		/// <summary>
		/// 여행기간2
		/// </summary>
		[Description("여행기간2")]
		public int TravelPeriod2 { get; set; }
		/// <summary>
		/// PTID
		/// </summary>
		[Description("PTID")]
