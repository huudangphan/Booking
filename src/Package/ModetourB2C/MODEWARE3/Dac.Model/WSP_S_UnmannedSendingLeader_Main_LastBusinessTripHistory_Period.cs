...
/// <summary>
/// WSP_S_무인센딩인솔자_메인_지난출장내역_기간
/// </summary>
public class WSP_S_UnmannedSendingLeader_Main_LastBusinessTripHistory_Period
{
	public const string SP_NAME = "WSP_S_무인센딩인솔자_메인_지난출장내역_기간";
