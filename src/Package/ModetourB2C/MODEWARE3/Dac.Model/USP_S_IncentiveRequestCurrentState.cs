...
/// USP_S_인센티브요청현황
/// </summary>
public class USP_S_IncentiveRequestCurrentState
{
	public const string SP_NAME = "USP_S_인센티브요청현황";
	...
	public class Parameters : BaseDbParameters
	{
		...
		/// </summary>
		[Description("영업담당")]
		public int BusinessResponsibility { get; set; }
		/// <summary>
		/// 영업OP
		/// </summary>
		[Description("영업OP")]
		...
		/// </summary>
		[Description("상품담당")]
		public int ProductResponsibility { get; set; }
		/// <summary>
		/// 영업본부
		/// </summary>
		[Description("영업본부")]
		public int BusinessHeadoffice { get; set; }
		/// <summary>
		/// 영업부문
		/// </summary>
		[Description("영업부문")]
		public int BusinessSection { get; set; }
		/// <summary>
		/// 거래처번호
		/// </summary>
		[Description("거래처번호")]
		...
		/// </summary>
		[Description("상품본부")]
		public int ProductHeadoffice { get; set; }
		/// <summary>
		/// 상품부문
		/// </summary>
		[Description("상품부문")]
		public int ProductDepartmentGate { get; set; }
	}
