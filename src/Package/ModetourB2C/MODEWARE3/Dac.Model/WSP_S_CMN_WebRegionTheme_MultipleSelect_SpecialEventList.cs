...
/// <summary>
/// WSP_S_CMN_웹지역테마_다중선택_기획전리스트
/// </summary>
public class WSP_S_CMN_WebRegionTheme_MultipleSelect_SpecialEventList
{
	public const string SP_NAME = "WSP_S_CMN_웹지역테마_다중선택_기획전리스트";
