...
/// <summary>
/// WSP_S_CMN_복지몰_특선상품_상품코드_날짜리스트_출발일조건
/// </summary>
public class WSP_S_CMN_WelfareMall_SpecialSelectionProduct_ProductCode_DateList_DepartureDateConditions
{
	public const string SP_NAME = "WSP_S_CMN_복지몰_특선상품_상품코드_날짜리스트_출발일조건";
