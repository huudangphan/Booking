...
/// <summary>
/// ACP_DATA_MAIN_EVENT_DISPLAY_REG
/// </summary>
public class ACP_DATA_MAIN_EVENT_DISPLAY_REG
{
	public const string SP_NAME = "ACP_DATA_MAIN_EVENT_DISPLAY_REG";
