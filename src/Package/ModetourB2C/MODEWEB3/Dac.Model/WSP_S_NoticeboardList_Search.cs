...
/// WSP_S_게시판리스트_검색
/// </summary>
public class WSP_S_NoticeboardList_Search
{
	public const string SP_NAME = "WSP_S_게시판리스트_검색";
	...
	public class Parameters : BaseDbParameters
	{
		...
		/// 말머리
		/// </summary>
		[DapperParameter(DbType.AnsiString, ParameterDirection.InputOutput, 30)]
		[Description("말머리")]
