...
/// <summary>
/// WSP_S_CMN_이벤트_리스트_관리자_2015
/// </summary>
public class WSP_S_CMN_Event_List_Admin_2015
{
	public const string SP_NAME = "WSP_S_CMN_이벤트_리스트_관리자_2015";
	...
	public class Parameters : BaseDbParameters
	{
		...
		/// </summary>
		[Description("구역번호리스트")]
		public string AreaNumberList { get; set; }
		/// <summary>
		/// 사용여부리스트
		/// </summary>
		[Description("사용여부리스트")]
		public string UseOrNotList { get; set; }
		/// <summary>
		/// 현재페이지
		/// </summary>
		[Description("현재페이지")]
