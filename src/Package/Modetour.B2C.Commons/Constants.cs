namespace Modetour.B2C.Commons
{
    public static class Constants
    {
        ...
        {
            public const string MAIL_SENDER = "support@modetour.com";
            public const string MAIL_API_KEY = "1d0ecd00-01a7-4760-9c1d-77506002d418";
            public const string MAIL_SEVER = "http://agentapi.modetour.com/Mail/Send/";
        }
